    ...
    <Box flex="1" >
      ...
      />
       ...
       <View style={{padding:10}}>
          <Text style={{fontSize:18,color:'#0AB4B6',fontWeight:'bold'}}>Match the following. Click on the images in the left column, and then pair them up with the images in the right column</Text>
       </View> 
       {Questions.length>0 ?
                ...
                <View style={{flex:1}}>
                    ...
                    <View style={{flexDirection:'row',marginTop:10}}>
                         <TouchableOpacity  style={AppStyle.itemContainer} onPress={()=>setSelectedLeft(3)} >
                           {isValidUrl(Questions[0].questionsRow[2])?
                            <View style={{padding:4}}>
                                <Image source={{uri:Questions[0].questionsRow[2]}} resizeMode={'contain'} style={{height:65,width:'100%'}} />
                            </View>:
                            <View style={{padding:5,marginTop:25}}>
                    ...
                    <View style={{flexDirection:'row',marginTop:10}}>
                          <TouchableOpacity  style={AppStyle.itemContainer} onPress={()=>setSelectedLeft(4)} >
                            ...
                            <View style={{padding:4}}>
                                <Image source={{uri:Questions[0].questionsRow[3]}} resizeMode={'contain'} style={{height:65,width:'100%'}} />
                            </View>:
                            <View style={{padding:5,marginTop:25}}>
                    ...
                    <View style={{flexDirection:'row',marginTop:10}}>
                         <TouchableOpacity  style={AppStyle.itemContainer} onPress={()=>setSelectedLeft(5)} >
                           {isValidUrl(Questions[0].questionsRow[4])?
                            <View style={{padding:4}}>
                                <Image source={{uri:Questions[0].questionsRow[4]}} resizeMode={'contain'} style={{height:65,width:'100%'}} />
                            </View>:
                            <View style={{padding:5,marginTop:25}}>
                    ...
                    <View style={{flexDirection:'row',marginTop:10}}> 
                        ...
                        <TouchableOpacity  style={AppStyle.itemContainer} onPress={()=>setCheckAnswer(1)} >
                          {isValidUrl(Questions[0].answerRow[0])?
                            <View style={{padding:4}}>
                                <Image source={{uri:CheckAnswerExist(45)?Questions[0].colorRow[0]:Questions[0].answerRow[0]}} resizeMode={'contain'} style={{height:65,width:'100%'}} />
                            </View>: 
                            <View style={{padding:5,marginTop:25}}>
                    ...
                    <View style={{flexDirection:'row',marginTop:10}}> 
                        ...
                        <TouchableOpacity  style={AppStyle.itemContainer} onPress={()=>setCheckAnswer(2)}>
                          {isValidUrl(Questions[0].answerRow[1])?
                            <View style={{padding:4}}>
                                <Image source={{uri:CheckAnswerExist(125)?Questions[0].colorRow[1]:Questions[0].answerRow[1]}} resizeMode={'contain'} style={{height:65,width:'100%'}} />
                            </View>:
                            <View style={{padding:5,marginTop:25}}>
                    ...
                    <View style={{flexDirection:'row',marginTop:10}}> 
                        ...
                        <TouchableOpacity  style={AppStyle.itemContainer} onPress={()=>setCheckAnswer(3)}>
                          {isValidUrl(Questions[0].answerRow[2])?
                            <View style={{padding:4}}>
                                <Image source={{uri:CheckAnswerExist(205)?Questions[0].colorRow[2]:Questions[0].answerRow[2]}} resizeMode={'contain'} style={{height:65,width:'100%'}} />
                            </View>:
                            <View style={{padding:5,marginTop:25}}>
                    ...
                    <View style={{flexDirection:'row',marginTop:10}}> 
                        ...
                        <TouchableOpacity  style={AppStyle.itemContainer} onPress={()=>setCheckAnswer(4)} >
                          {isValidUrl(Questions[0].answerRow[3])?
                            <View style={{padding:4}}>
                                <Image source={{uri:CheckAnswerExist(285)?Questions[0].colorRow[3]:Questions[0].answerRow[3]}} resizeMode={'contain'} style={{height:65,width:'100%'}} />
                            </View>:
                            <View style={{padding:5,marginTop:25}}>
                    ...
                    <View style={{flexDirection:'row',marginTop:10}}> 
                        ...
                        <TouchableOpacity  style={AppStyle.itemContainer} onPress={()=>setCheckAnswer(5)}>
                          {isValidUrl(Questions[0].answerRow[4])?
                            <View style={{padding:4}}>
                                <Image source={{uri:CheckAnswerExist(365)?Questions[0].colorRow[4]:Questions[0].answerRow[4]}} resizeMode={'contain'} style={{height:65,width:'100%'}} />
                            </View>:
                            <View style={{padding:5,marginTop:25}}>
