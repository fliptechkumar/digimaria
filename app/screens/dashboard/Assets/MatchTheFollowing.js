    ...
    <Box flex="1" >
      ...
      />
       ...
       <View style={{padding:10}}>
          <Text style={{fontSize:16,color:'#0AB4B6',fontWeight:'bold'}}>Match the following. Click on the images in the left column, and then pair them up with the images in the right column</Text>
       </View> 
                ...
                <View style={{flex:1}}>
                    <View style={{flexDirection:'row',marginTop:10}}>
                        <TouchableOpacity  style={AppStyle.itemContainer } onPress={()=>setSelectedLeft(1)} >
                          {isValidUrl(Questions[0].questionsRow[0])?
                            <View style={{padding:2}}>
                                <Image source={{uri:Questions[0].questionsRow[0]}} alt={Questions[0].questionsRow[0]} resizeMode={'contain'} style={{height:70,width:'100%'}} />
                            </View>:
                        ...
                        <View style={{justifyContent:'center',height:70,paddingLeft:5}} >
                            <FontAwesomeIcon name='dot-circle-o' size={25} color={(selectedAnswerArray[1]!=null || selectedLeft==1)?'#f00665':'#808080'} style={{left:2,zIndex:2}} />
                        </View>
                    </View>
                    <View style={{flexDirection:'row',marginTop:10}}>
                         <TouchableOpacity  style={AppStyle.itemContainer} onPress={()=>setSelectedLeft(2)} >
                           {isValidUrl(Questions[0].questionsRow[1])?
                            <View style={{padding:4}}>
                                <Image source={{uri:Questions[0].questionsRow[1]}} alt={'digi'} resizeMode={'contain'} style={{height:65,width:'100%'}}  />
                        ...
                        <View style={{justifyContent:'center',height:70,paddingLeft:5}} >
                            ...
                            <FontAwesomeIcon name='dot-circle-o' size={25} color={(selectedAnswerArray[2]!=null || selectedLeft==2)?'#f00665':'#808080'} style={{left:2,zIndex:2}} />
                        </View>
                    </View>
                    <View style={{flexDirection:'row',marginTop:10}}>
                         <TouchableOpacity  style={AppStyle.itemContainer} onPress={()=>setSelectedLeft(3)} >
                           {isValidUrl(Questions[0].questionsRow[2])?
                            <View style={{padding:4}}>
                                <Image source={{uri:Questions[0].questionsRow[2]}} resizeMode={'contain'} style={{height:65,width:'100%'}} alt='digi' />
                            </View>:
                            <View style={{padding:5,marginTop:25}}>
                        ...
                        <View style={{justifyContent:'center',height:70,paddingLeft:5}} >
                            {/* <View  style={{borderRadius:20,width:20,borderWidth:3,height:20,left:2,}} /> */}
                            <FontAwesomeIcon name='dot-circle-o' size={25} color={(selectedAnswerArray[3]!=null || selectedLeft==3)?'#f00665':'#808080'} style={{left:2,zIndex:2}} />
                        </View>
                    </View>
                    <View style={{flexDirection:'row',marginTop:10}}>
                          <TouchableOpacity  style={AppStyle.itemContainer} onPress={()=>setSelectedLeft(4)} >
                            ...
                            <View style={{padding:4}}>
                                <Image source={{uri:Questions[0].questionsRow[3]}} resizeMode={'contain'} style={{height:65,width:'100%'}} alt='digi' />
                            </View>:
                            <View style={{padding:5,marginTop:25}}>
                        ...
                        <View style={{justifyContent:'center',height:70,paddingLeft:5}} >
                            {/* <View  style={{borderRadius:20,width:20,borderWidth:3,height:20,left:2,}} /> */}
                            <FontAwesomeIcon name='dot-circle-o' size={25} color={(selectedAnswerArray[4]!=null || selectedLeft==4)?'#f00665':'#808080'} style={{left:2,zIndex:2}} />
                        </View>
                    </View>
                    ...
                    <View style={{flexDirection:'row',marginTop:10}}>
                         <TouchableOpacity  style={AppStyle.itemContainer} onPress={()=>setSelectedLeft(5)} >
                           {isValidUrl(Questions[0].questionsRow[4])?
                            <View style={{padding:4}}>
                                <Image source={{uri:Questions[0].questionsRow[4]}} resizeMode={'contain'} style={{height:65,width:'100%'}} alt='digi' />
                            </View>:
                            <View style={{padding:5,marginTop:25}}>
                        ...
                        <View style={{justifyContent:'center',height:70,paddingLeft:5}} >
                            {/* <View  style={{borderRadius:20,width:20,borderWidth:3,height:20,left:2,}} /> */}
                            <FontAwesomeIcon name='dot-circle-o' size={25} color={(selectedAnswerArray[5]!=null || selectedLeft==5)?'#f00665':'#808080'} style={{left:2,zIndex:2}} />
                        </View>
                    </View>}
                </View>
                    ...
                    <View style={{flexDirection:'row',marginTop:10}}> 
                        ...
                        <TouchableOpacity  style={AppStyle.itemContainer} onPress={()=>setCheckAnswer(1)} >
                          {isValidUrl(Questions[0].answerRow[0])?
                            <View style={{padding:4}}>
                                <Image source={{uri:Questions[0].answerRow[0]}} resizeMode={'contain'} style={{height:65,width:'100%'}} alt='digi' />
                            </View>:
                            <View style={{padding:5,marginTop:25}}>
                    ...
                    <View style={{flexDirection:'row',marginTop:10}}> 
                        ...
                        <TouchableOpacity  style={AppStyle.itemContainer} onPress={()=>setCheckAnswer(2)}>
                          {isValidUrl(Questions[0].answerRow[1])?
                            <View style={{padding:4}}>
                                <Image source={{uri:Questions[0].answerRow[1]}} resizeMode={'contain'} style={{height:65,width:'100%'}} alt='digi' />
                            </View>:
                            <View style={{padding:5,marginTop:25}}>
                    ...
                    <View style={{flexDirection:'row',marginTop:10}}> 
                        ...
                        <TouchableOpacity  style={AppStyle.itemContainer} onPress={()=>setCheckAnswer(3)}>
                          {isValidUrl(Questions[0].answerRow[2])?
                            <View style={{padding:4}}>
                                <Image source={{uri:Questions[0].answerRow[2]}} resizeMode={'contain'} style={{height:65,width:'100%'}} alt='digi' />
                            </View>:
                            <View style={{padding:5,marginTop:25}}>
                    ...
                    <View style={{flexDirection:'row',marginTop:10}}> 
                        ...
                        <TouchableOpacity  style={AppStyle.itemContainer} onPress={()=>setCheckAnswer(4)} >
                          {isValidUrl(Questions[0].answerRow[3])?
                            <View style={{padding:4}}>
                                <Image source={{uri:Questions[0].answerRow[3]}} resizeMode={'contain'} style={{height:65,width:'100%'}} alt='digi' />
                            </View>:
                            <View style={{padding:5,marginTop:25}}>
                    ...
                    <View style={{flexDirection:'row',marginTop:10}}> 
                        ...
                        <TouchableOpacity  style={AppStyle.itemContainer} onPress={()=>setCheckAnswer(5)}>
                          {isValidUrl(Questions[0].answerRow[4])?
                            <View style={{padding:4}}>
                                <Image source={{uri:Questions[0].answerRow[4]}} resizeMode={'contain'} style={{height:65,width:'100%'}} alt='digi' />
                            </View>:
                            <View style={{padding:5,marginTop:25}}>
