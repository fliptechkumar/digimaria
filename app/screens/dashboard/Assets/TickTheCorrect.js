                           ...
                           <View style={{flexDirection:'row'}}>
                                ...
                                <View style={{flexDirection:'row'}}>
                                   <Text style={{fontWeight:'bold',fontSize:16}}>{index+1} </Text>
                                    <Checkbox accessibilityLabel={item}  value={index+1}  onChange={()=>{setCheckAnswer(index+1,currentIndex)}} size={'lg'} isInvalid={wrongCheckbox==index+1?true:false}  colorScheme={wrongCheckbox==index+1?'danger':"green"}  />
                                   </View>
                                </View>
                                <View style={{flex:3.2}}>
                            {isValidUrl(item)?
