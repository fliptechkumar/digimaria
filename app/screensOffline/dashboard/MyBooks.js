  ...
  const OpenModel = (type, item) => {
    ...
    if (type == 'ebook') {
      ...
      if (isDownload){
        ...
        //alert('Please Download the Book First');
        setShowDownload(true);
        if(isConnected){
           ResetData();
           getChapters(item.id);
        }else{
           setInternetError('Please Check Your Internet Connection and Try Again');
           setTimeout(() => {
                ...
                <View style={{width: '100%', marginTop: 10}}>
                  ...
                  <View style={{flexDirection:'row',justifyContent:'space-between', backgroundColor: '#f15972',
                       ...
                       flex:3
                          ...
                          {isDownload ? (
                          <TouchableOpacity onPress={()=>UpdateChapters(id)} style={{flex:1}}>
                            <View style={{alignItems:'flex-end'}}>
                             <MyIcon name="edit" size={25} color="#fff" />
                            </View>
                          </TouchableOpacity>
                          ) : (
                ...
                <View style={{width: '100%', marginTop: 10}}>
                  ...
                  <TouchableOpacity
                    ...
                    <View style={{justifyContent: 'center',flexDirection:'row',justifyContent:'space-between'}}>
                      ...
                      {isDownload ? (
                        <MyIcon name="book" size={20} color="#fff" />
                      ) : (
