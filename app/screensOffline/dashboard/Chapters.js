...
export default function Home(props) {
	...
	const { getChapters, chapterList, loading, contentsList,setLocalChapterList } = useDetailsAll();
				...
				<Actionsheet.Content style={{ backgroundColor: '#f1e8c7' }}>
					...
					<View style={{ width: '100%', marginTop: 10 }} >
						<TouchableOpacity onPress={() => {
							if (selectedChapter && selectedChapter.localvideo) {
								setShowContent(false);
								props.navigation.navigate('VideoAsset', { assets: selectedChapter.localvideo, title: title })
							} else {
								if(isConnected){
							...
							<View style={{ justifyContent: 'center', flexDirection: 'row',justifyContent:'space-between' }}>
								...
								{selectedChapter && selectedChapter.localvideo ? (
                       ...
                       flex:3
                          ...
                          <TouchableOpacity onPress={()=>DeleteTask(selectedChapter.id)} style={{flex:1}}>
                            ...
                            !showDownload? <TouchableOpacity style={{flex:1}} onPress={() => OpenModel('chapters', id)}>
                            <View style={{alignItems:'flex-end'}}>
