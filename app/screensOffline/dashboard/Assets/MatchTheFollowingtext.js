...
export default function Home(props) {
 ...
 // let options=["Green","Orange","Yellow","Purple","Orange"];
  ...
  const setCheckAnswer = (value) => {
    ...
    if(value==Questions[0].answers[selectedLeft]){
 ...
 const CompletedActivity=()=>{
  ...
  useEffect(()=>{
   //alert(JSON.stringify(selectedAnswerArray));
                    ...
                    <View style={{flexDirection:'row',marginTop:10}}>
                        <TouchableOpacity  style={AppStyle.itemContainer} onPress={()=>setSelectedLeft(1)} >
                            <View style={{padding:2}}>
                                <Image source={{uri:Questions[0].questionsRow[0]}} resizeMode={'contain'} style={{height:70,width:'100%'}} />
                            </View>
                          </TouchableOpacity>
                    ...
                    <View style={{flexDirection:'row',marginTop:10}}>
                         <TouchableOpacity  style={AppStyle.itemContainer} onPress={()=>setSelectedLeft(2)} >
                            <View style={{padding:4}}>
                                <Image source={{uri:Questions[0].questionsRow[1]}} resizeMode={'contain'} style={{height:65,width:'100%'}} />
                            </View>
                          </TouchableOpacity>
                        <View style={{justifyContent:'center',height:70,paddingLeft:5}} >
                ...
                <View style={{flex:1}}>
                    <View style={{flexDirection:'row',marginTop:10}}> 
                        ...
                        <TouchableOpacity  style={AppStyle.itemContainer} onPress={()=>setCheckAnswer(1)} >
                            <View style={{padding:4}}>
                                <Image source={{uri:Questions[0].answerRow[0]}} resizeMode={'contain'} style={{height:65,width:'100%'}} />
                            </View>
                          </TouchableOpacity>
                    </View>
                    <View style={{flexDirection:'row',marginTop:10}}> 
                        ...
                        <TouchableOpacity  style={AppStyle.itemContainer} onPress={()=>setCheckAnswer(2)}>
                            <View style={{padding:4}}>
                                <Image source={{uri:Questions[0].answerRow[1]}} resizeMode={'contain'} style={{height:65,width:'100%'}} />
                            </View>
                          </TouchableOpacity>
                    </View>
                    <View style={{flexDirection:'row',marginTop:10}}> 
                        ...
                        <TouchableOpacity  style={AppStyle.itemContainer} onPress={()=>setCheckAnswer(3)}>
                            <View style={{padding:4}}>
                                <Image source={{uri:Questions[0].answerRow[2]}} resizeMode={'contain'} style={{height:65,width:'100%'}} />
                            </View>
                          </TouchableOpacity>
                    </View>
                    <View style={{flexDirection:'row',marginTop:10}}> 
                        ...
                        <TouchableOpacity  style={AppStyle.itemContainer} onPress={()=>setCheckAnswer(4)} >
                            <View style={{padding:4}}>
                                <Image source={{uri:Questions[0].answerRow[3]}} resizeMode={'contain'} style={{height:65,width:'100%'}} />
                            </View>
                          </TouchableOpacity>
                    </View>
                    <View style={{flexDirection:'row',marginTop:10}}> 
                        ...
                        <TouchableOpacity  style={AppStyle.itemContainer} onPress={()=>setCheckAnswer(5)}>
                            <View style={{padding:4}}>
                                <Image source={{uri:Questions[0].answerRow[4]}} resizeMode={'contain'} style={{height:65,width:'100%'}} />
                            </View>
                          </TouchableOpacity>
                    </View>
                </View>
