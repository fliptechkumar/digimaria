	...
	return (
		 <DraxView
			  ...
			  renderContent={({ viewState }) => {
                  ...
                  :
                  questions.length>0? <Text style={styles.textStyleQuestion}> {item.question.replace("-", '_________ ')}</Text>:false
                }
                { item && item.image && item.answerimage && correctAnswer==false ?
                  <Image source={{uri:'file://'+item.image}} resizeMode="contain" style={{width:100,height:100,alignSelf:'center'}}/>
                  : item && item.answerimage && correctAnswer==true ?
                  <Image source={{uri:'file://'+item.answerimage}} resizeMode="contain" style={{width:100,height:100,alignSelf:'center'}}/>
                  :false
                }
            ...
            <DraxProvider>
                <View style={styles.container}>
                  <View style={{flexDirection:'row',justifyContent:'space-between'}}>
                    ...
                    <Image source={{uri:'file://'+questions[currentIndex].image}} resizeMode="contain" style={{width:100,height:100}}/>
                    </View>:false}
                    </View>
