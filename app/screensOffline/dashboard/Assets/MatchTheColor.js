                    ...
                    <View style={{flexDirection:'row',marginTop:10}}> 
                        ...
                        <TouchableOpacity  style={AppStyle.itemContainer} onPress={()=>setCheckAnswer(1)} >
                          {isValidUrl(Questions[0].answerRow[0])?
                            <View style={{padding:4}}>
                                <Image source={{uri:CheckAnswerExist(45)?'file://'+Questions[0].colorRow[0]:'file://'+Questions[0].answerRow[0]}} resizeMode={'contain'} style={{height:65,width:'100%'}} />
                            </View>: 
                            <View style={{padding:5,marginTop:25}}>
                    ...
                    <View style={{flexDirection:'row',marginTop:10}}> 
                        ...
                        <TouchableOpacity  style={AppStyle.itemContainer} onPress={()=>setCheckAnswer(2)}>
                          {isValidUrl(Questions[0].answerRow[1])?
                            <View style={{padding:4}}>
                                <Image source={{uri:CheckAnswerExist(125)?'file://'+Questions[0].colorRow[1]:'file://'+Questions[0].answerRow[1]}} resizeMode={'contain'} style={{height:65,width:'100%'}} />
                            </View>:
                            <View style={{padding:5,marginTop:25}}>
                    ...
                    <View style={{flexDirection:'row',marginTop:10}}> 
                        ...
                        <TouchableOpacity  style={AppStyle.itemContainer} onPress={()=>setCheckAnswer(3)}>
                          {isValidUrl(Questions[0].answerRow[2])?
                            <View style={{padding:4}}>
                                <Image source={{uri:CheckAnswerExist(205)?'file://'+Questions[0].colorRow[2]:'file://'+Questions[0].answerRow[2]}} resizeMode={'contain'} style={{height:65,width:'100%'}} />
                            </View>:
                            <View style={{padding:5,marginTop:25}}>
                    ...
                    <View style={{flexDirection:'row',marginTop:10}}> 
                        ...
                        <TouchableOpacity  style={AppStyle.itemContainer} onPress={()=>setCheckAnswer(4)} >
                          {isValidUrl(Questions[0].answerRow[3])?
                            <View style={{padding:4}}>
                                <Image source={{uri:CheckAnswerExist(285)?'file://'+Questions[0].colorRow[3]:'file://'+Questions[0].answerRow[3]}} resizeMode={'contain'} style={{height:65,width:'100%'}} />
                            </View>:
                            <View style={{padding:5,marginTop:25}}>
                    ...
                    <View style={{flexDirection:'row',marginTop:10}}> 
                        ...
                        <TouchableOpacity  style={AppStyle.itemContainer} onPress={()=>setCheckAnswer(5)}>
                          {isValidUrl(Questions[0].answerRow[4])?
                            <View style={{padding:4}}>
                                <Image source={{uri:CheckAnswerExist(365)?'file://'+Questions[0].colorRow[4]:'file://'+Questions[0].answerRow[4]}} resizeMode={'contain'} style={{height:65,width:'100%'}} />
                            </View>:
                            <View style={{padding:5,marginTop:25}}>
